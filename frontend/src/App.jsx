...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:p-4 focus:bg-white focus:text-teal-700 focus:font-bold top-0 left-0">Skip to main content</a>
      {/* ── Navbar ── */}
