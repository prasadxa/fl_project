...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute -top-[100px] left-4 z-[100] px-4 py-2 bg-teal-600 text-white font-bold rounded-b-lg focus:top-0 transition-all focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 shadow-lg"
      >
        Skip to content
      </a>
