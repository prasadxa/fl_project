...
def escape_latex(s: str) -> str:
    """Escapes special characters for LaTeX using a single-pass translation."""
    if s is None:
        return ""
    s = str(s)
    # Define mapping of special characters to their escaped equivalents
    latex_special_chars = {
        '&': r'\&',
        '%': r'\%',
        '$': r'\$',
    ...
    trans = str.maketrans(latex_special_chars)
