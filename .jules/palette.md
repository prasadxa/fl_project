...
## 2026-05-10 - Add skip to main content link
**Learning:** Implementing skip links in React SPAs requires setting `tabIndex={-1}` on the target container to allow programmatic focus without disrupting normal tab flow.
**Action:** Always add skip links to major layout components with proper focus management.
