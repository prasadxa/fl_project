...
def escape_latex(s):
    ...
    return str(s).translate(LATEX_SUBS)
...
def build_latex_report(req: ReportRequest) -> bytes:
    with tempfile.TemporaryDirectory() as d:
        ...
        patient_name = escape_latex(req.patient.patient_name)
        patient_id = escape_latex(req.patient.patient_id)
        date_of_birth = escape_latex(req.patient.date_of_birth)
        gender = escape_latex(req.patient.gender)
