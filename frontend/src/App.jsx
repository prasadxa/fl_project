...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute -top-[100px] left-0 z-[100] m-3 p-3 bg-teal-600 text-white font-bold rounded-xl focus:top-0 transition-all focus:outline-none focus:ring-4 focus:ring-teal-500/50"
      >
