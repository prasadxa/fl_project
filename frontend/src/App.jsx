...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute -top-[100px] left-4 z-[60] focus:top-4 px-4 py-2 bg-teal-600 text-white font-medium rounded-lg shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
      >
        Skip to content
      </a>
      {/* ── Navbar ── */}
