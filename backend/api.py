...
def admin_export_csv(_: str = Depends(verify_admin)):
...
def admin_export_excel(_: str = Depends(verify_admin)):
    """
...
def admin_sessions(limit: int = 50, offset: int = 0, _: str = Depends(verify_admin)):
