...
def verify_admin(credentials: HTTPBasicCredentials = Depends(security)):
    """Verifies HTTP Basic Auth using env vars."""
    ...
    is_user_ok = secrets.compare_digest(credentials.username.encode("utf-8"), admin_user.encode("utf-8"))
    is_pass_ok = secrets.compare_digest(credentials.password.encode("utf-8"), admin_pass.encode("utf-8"))
