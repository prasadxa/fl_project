...
def verify_admin(creds: HTTPBasicCredentials = Depends(_security)):
    ...
    if not (secrets.compare_digest(creds.username, u) and secrets.compare_digest(creds.password, p)):
