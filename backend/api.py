...
def admin_stats(admin_user: str = Depends(verify_admin)):
...
def admin_export_csv(admin_user: str = Depends(verify_admin)):
...
def admin_export_excel(admin_user: str = Depends(verify_admin)):
    """
...
def admin_sessions(limit: int = 50, offset: int = 0, admin_user: str = Depends(verify_admin)):
