...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-[100] px-4 py-2 bg-teal-600 text-white font-medium rounded-br-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
      >
        Skip to main content
      </a>
