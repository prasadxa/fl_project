...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute top-4 left-4 bg-teal-600 text-white px-4 py-2 rounded-lg font-medium shadow-lg focus:z-[100] transition-all">Skip to main content</a>
      {/* ── Navbar ── */}
