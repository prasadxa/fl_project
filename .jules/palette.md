...
## 2026-05-23 - Add skip to main content link
**Learning:** Implementing a skip link with Tailwind requires focus:z-[100] to bypass sticky headers, and the target container must have tabIndex={-1} and outline-none to receive programmatic focus smoothly.
**Action:** Always include these classes and attributes when adding skip links.
