...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute -top-[100px] left-0 m-3 z-[100] p-3 bg-teal-600 text-white font-bold rounded-lg focus:top-0 transition-all focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300"
      >
        Skip to content
      </a>
