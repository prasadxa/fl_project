...
def admin_export_csv(username: str = Depends(verify_admin)):
...
def admin_export_excel(username: str = Depends(verify_admin)):
    """
...
def admin_sessions(limit: int = 50, offset: int = 0, username: str = Depends(verify_admin)):
