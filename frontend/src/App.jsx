...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-[100] px-4 py-2 bg-teal-600 text-white rounded-lg font-bold shadow-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
      >
