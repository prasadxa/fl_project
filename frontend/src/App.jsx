...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      <a
        href="#main-content"
        className="absolute -top-[100px] focus:top-[10px] left-[10px] z-[100] transition-all bg-teal-600 text-white px-4 py-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 font-medium shadow-lg"
      >
