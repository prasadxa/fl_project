...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* ── Skip Link ── */}
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-[100] px-4 py-2 bg-teal-600 text-white font-bold top-0 left-0 rounded-br-lg shadow-lg">
