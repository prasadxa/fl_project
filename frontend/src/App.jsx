...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute -top-[100px] focus:top-0 left-0 bg-teal-600 text-white font-bold py-2 px-4 z-[9999] transition-all rounded-br-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2"
      >
        Skip to content
      </a>
