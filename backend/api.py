...
def admin_stats(admin: str = Depends(get_admin)):
...
def admin_export_csv(admin: str = Depends(get_admin)):
...
def admin_export_excel(admin: str = Depends(get_admin)):
    """
...
def admin_sessions(limit: int = 50, offset: int = 0, admin: str = Depends(get_admin)):
