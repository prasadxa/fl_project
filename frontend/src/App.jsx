...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:p-4 focus:bg-white focus:text-teal-700 font-bold focus:shadow-md focus:outline-none focus:ring-2 focus:ring-teal-500"
      >
