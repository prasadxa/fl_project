...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-[100] top-4 left-4 bg-teal-600 text-white px-4 py-2 rounded-lg font-medium shadow-lg outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
