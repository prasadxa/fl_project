...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute left-0 -top-[100px] z-50 p-4 bg-white text-teal-700 transition-all focus:top-0 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-md font-medium rounded-br-lg"
      >
