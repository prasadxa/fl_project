...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a href="#main-content" className="absolute -top-[100px] focus:top-0 focus:z-[100] left-4 bg-teal-600 text-white px-4 py-2 rounded-b-lg font-medium transition-all focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">Skip to content</a>
      {/* ── Navbar ── */}
