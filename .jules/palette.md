...
## 2026-04-29 - Add skip to main content link
**Learning:** Implementing skip links requires the target container to have `tabIndex={-1}` for programmatic focus and `outline-none` to avoid default focus rings.
**Action:** Always verify keyboard navigation and focus management when adding accessibility links.
