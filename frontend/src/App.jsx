...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute -top-[100px] left-1/2 -translate-x-1/2 focus:top-4 z-[60] bg-teal-600 text-white px-4 py-2 rounded-lg shadow-xl font-bold transition-all focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300"
      >
        Skip to content
      </a>
      {/* ── Navbar ── */}
