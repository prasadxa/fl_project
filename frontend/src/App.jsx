...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        href="#main-content"
        className="absolute -top-[100px] focus:top-0 transition-all z-[100] px-4 py-2 bg-white text-teal-700 font-medium rounded-br-lg shadow-md focus:outline-none focus:ring-2 focus:ring-teal-500"
      >
