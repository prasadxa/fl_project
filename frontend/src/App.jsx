...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-[100] px-4 py-2 bg-white text-teal-700 font-bold top-0 left-0">Skip to main content</a>
      {/* ── Navbar ── */}
